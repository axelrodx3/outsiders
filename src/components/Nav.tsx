    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-tavern-black/95 backdrop-blur border-b border-tavern-gray">
      <div className="w-full flex items-center justify-between px-6 md:px-8 py-3">
        ...
        <div className="hidden md:flex items-center gap-8">
            ...
            <a href="https://www.doordash.com/store/outsiders-tavern-rock-hill-31872831/48795546/" target="_blank" rel="noopener noreferrer" className="text-tavern-white/90 hover:text-tavern-white transition-colors">Order</a>
